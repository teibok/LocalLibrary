# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-07-14 10:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='Enter a bniah description of the book', max_length=1000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter a book genre (Order: Chyne)', max_length=200)),
            ],
        ),
        migrations.AddField(
            model_name='book',
